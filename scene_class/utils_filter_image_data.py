...
def main(config):
    if not os.path.isfile(
        "/mnt/ushelf_star_th/data/PAI_diptera/annotation_data/json.csv"
    ):
        directory = (
            "/mnt/ushelf_star_th/data/PAI_diptera/annotation_data/json_felicitas"
        )
                ...
                with open(file_path, "r") as json_file:
                    ...
                    for jpeg in data["_via_img_metadata"]:
                        ...
                        jpeg_path = os.path.join(
                            "/mnt/ushelf_star_th/data/PAI_diptera/image_data",
    ...
    x, y, width, height = (
        df["x"].iloc[random_number],
        df["y"].iloc[random_number],
        df["w"].iloc[random_number],
        df["h"].iloc[random_number],
    )
    ...
    if args.croptoBBox:
        ...
        img_save_base_path = (
            r"/mnt/ushelf_star_th/data/PAI_diptera/image_data_filtered_noBB"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--croptoBBox", type=bool, default=False, help="Crop image to bounding box"
    )
