...
```bash
python get_gbif_data.py
```

This script retrieves occurrence records from GBIF and stores them in:
...
Make sure `config.yaml` points to the correct data path.
